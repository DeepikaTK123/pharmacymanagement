...
import { addStaff } from "networks"; // Adjust the path as necessary
...
const AddStaff = ({ isOpen, onClose }) => {
  const [newStaff, setNewStaff] = useState({
    ...
    jobTitle: '',
    licenseNumber: '',
    profilePreview: '', // for previewing the selected profile picture
  });
  // const [newStaff, setNewStaff] = useState({
  //   name: 'John Doe',
  //   role: 'Doctor',
  ...
  //   licenseNumber: 'SE123456',
  //   profilePreview: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAA...', // example base64 image data
  // });
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="6xl">
      <ModalOverlay />
      <ModalContent>
        <ModalHeader>Add Hospital Staff</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
